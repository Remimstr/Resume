...
\begin{twenty} % Environment for a list with descriptions
	...
	\twentyitem{Spring 2016}{Bioinformatics Student}{National Microbiology Laboratory, Guelph}{
		\begin{itemize}
				...
				\item{Implemented automation in python using custom spellchecker and controlled list modules to reduce the manual curation required}
				\item{\href{https://github.com/Remimstr/Standardize_Metadata}{https://github.com/Remimstr/Standardize\_Metadata}}
		\end{itemize}}
