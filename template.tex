...
\aboutme{\begin{itemize}
		...
		\item{Passion for being part of a team that accomplishes ambitious goals such as whole genome cancer analysis}
...
\begin{twenty} % Environment for a list with descriptions
	\twentyitem{Fall 2016}{Bioinformatics Support}{Neufeld Lab, Waterloo}{
		\begin{itemize}
			   ...
			   \item{Created and modified scripts as required by researchers}
			   \item{Prioritized tasks and documented work carefully through github}
		\end{itemize}}
	\twentyitem{Spring 2016}{Bioinformatics Student}{National Microbiology Laboratory, Guelph}{
		\begin{itemize}
				\item{Applied programming skills to create tools for the curation of > 63,000 Salmonella samples resulting in a comprehensive collection of metadata to be used for analysis}
				\item{Implemented automation in python using custom spellchecker and controlled list modules reducing manual curation required}
				\item{\href{https://github.com/Remimstr/Standardize_Metadata}{\color{blue}https://github.com/Remimstr/Standardize\_Metadata}}
		\end{itemize}}
	\twentyitem{Fall 2015}{Computational Cancer Genomics}{SickKids Hospital, Toronto}{Majoring in Computer Science}
	\twentyitem{Winter 2015}{Instructional Support Assistant}{Faculty of Math, University of Waterloo}{Specializing in mathematics and physics.}
