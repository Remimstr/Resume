...
\begin{itemize}
	...
	\item{Passion for being part of a team that accomplishes ambitious goals}
...
\begin{twenty} % Environment for a list with descriptions
	...
	\twentyitem{Spring 2016}{Bioinformatics Student}{National Microbiology Laboratory, Guelph}{
		\begin{itemize}
				\item{Wrote tools to curate data of > 63,000 Salmonella samples}
				\item{Implemented a spellchecker module and controlled lists in python to reduce manual curation required}
